...
%cite+page
\newcommand{\cpn}[2]{\pcr{#1}，第 #2 页}
%example        \cpn{cite}{4}   -> [3]，第 4 页
%If the auther use [3],<page> as supscript, and use 
%two of them at the same place, the \cp command can't handle this 
%because it will generate a ugly （[3]，第 4 页）（[5]，第 9 页）
%So we have to use \cnparen{\cpn{}{}；\cpn{}{}} to deal with this
...
%if you want to use [] directly, w/o an \enu command, 
%use \rep{a}{} or define
\newcommand{\repn}[1]{\rep{#1}{}}
